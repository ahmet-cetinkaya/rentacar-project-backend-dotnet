...
public class InvoicesController : BaseController
{
    ...
    {
        Invoice result = await Mediator.Send(createInvoiceCommand);
    ...
    {
        Invoice result = await Mediator.Send(updateInvoiceCommand);
        return Ok(result);
    }
    ...
    {
        Invoice result = await Mediator.Send(deleteInvoiceCommand);
        return Ok(result);
    }
}