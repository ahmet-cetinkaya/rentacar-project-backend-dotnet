...
public class FindeksCreditRatesController : BaseController
{
    ...
    {
        FindeksCreditRate result = await Mediator.Send(getByIdFindeksCreditRateQuery);
        return Ok(result);
    }
    ...
    {
        FindeksCreditRate result = await Mediator.Send(updateFindeksCreditRateCommand);
        return Ok(result);
    }
    ...
    {
        FindeksCreditRate result = await Mediator.Send(findeksCreditRateFromServiceCommand);
        return Ok(result);
    }
    ...
    {
        FindeksCreditRate result = await Mediator.Send(deleteFindeksCreditRateCommand);
        return Ok(result);
    }
}